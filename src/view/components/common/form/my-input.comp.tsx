        ...
        <div className="flex flex-col text-gray-600 dark:text-gray-400 ">
            ...
            {isTextArea ? (
                <textarea
                    ...
                    className={`bg-gray-100 dark:bg-gray-900 py-2.5 px-4 rounded-xl focus:outline-none  ${
                ...
                <input
                    ...
                    {...others}
                    //focus:ring-2 focus:ring-primary-light
                    className={`bg-gray-100 dark:bg-gray-900 py-2.5 px-4 rounded-md focus:outline-none ring-1 ring-gray-200  ${
                        error ? "ring-2 ring-danger" : ""
                    }`}
                />
            )}
